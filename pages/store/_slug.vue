    ...
    <div v-else>
      ...
      <v-card :loading="loading" color="grey darken-4" class="hidden-sm-and-down" dark>
        <div class="d-flex flex-no-wrap justify-space-between">
          <div>
            <v-carousel hide-delimiters cycle height="400px" hide-delimiter-background show-arrows-on-hover>
              <v-carousel-item width="400px" :src="'https://cwdstore.pythonanywhere.com' + product.featured_image"></v-carousel-item>
              <v-carousel-item width="400px" :src="'https://cwdstore.pythonanywhere.com' + product.image1"></v-carousel-item>
              <v-carousel-item width="400px" :src="'https://cwdstore.pythonanywhere.com' + product.image2"></v-carousel-item>
              <v-carousel-item width="400px" :src="'https://cwdstore.pythonanywhere.com' + product.image3"></v-carousel-item>
            </v-carousel>
          </div>
