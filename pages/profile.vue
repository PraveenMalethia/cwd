              ...
              <v-progress-circular
                ...
                <div v-if="customer.profile_pic">
                  <img
                    ...
                    width="182"
                    class="mt-1"
                    :src="'https://5868a103abcd.ngrok.io'+customer.profile_pic"
...
export default {
  ...
  methods: {
    loadCustomer(){
      ...
      this.$axios
        .get('https://5868a103abcd.ngrok.io/api/auth/customer/')
        .then((response) => {
    ...
    UpdateUser(){
      ...
      this.$axios.put('https://5868a103abcd.ngrok.io/api/auth/user/',this.user)
      .then((response) =>{
      ...
      if(this.UpdateCustomer.phone_number != null){
        this.$axios.put('https://5868a103abcd.ngrok.io/api/auth/customer/',this.UpdateCustomer)
        .then((response) =>{
          this.loadCustomer()
